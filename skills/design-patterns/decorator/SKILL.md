---
name: Decorator
description: Dynamically attach additional responsibilities to an object by providing a flexible alternative to subclassing, allowing behavior to be added or modified at runtime without altering the original object's code.
---
