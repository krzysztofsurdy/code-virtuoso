...
description: A behavioral pattern that allows adding new operations to object structures without modifying them. Perfect for traversing complex object hierarchies and performing operations that depend on element types.
---
