---
name: factory-method
description: A creational design pattern that creates objects without specifying their exact classes. Use when a class cannot anticipate the type of objects it needs to create, or when object creation logic is complex.
---
