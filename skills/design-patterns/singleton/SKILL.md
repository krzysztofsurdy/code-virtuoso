---
name: singleton
description: Creational pattern that restricts the instantiation of a class to a single object. Use when you need exactly one instance of a class that coordinates actions across a system, such as a database connection or logging service.
---
