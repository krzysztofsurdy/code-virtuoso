...
description: Define the skeleton of an algorithm in a base class but let subclasses override specific steps without changing the algorithm's structure. A behavioral pattern enabling code reuse and variation in a controlled manner.
---
