---
name: Memento
description: Capture and restore an object's internal state without violating encapsulation, enabling undo/redo functionality and state history management.
---
