...
description: Creational pattern that provides an interface for creating families of related or dependent objects without specifying their concrete classes. Use when your system needs to work with multiple families of products or when you want to enforce consistency across product families.
---
