---
name: Extract Class
description: Separate responsibilities by creating a new class for a cohesive subset of features, reducing class complexity and improving maintainability
---
