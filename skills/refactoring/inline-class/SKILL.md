---
name: Inline Class
description: A refactoring technique that merges an underutilized class with another class to reduce unnecessary complexity and improve code organization.
---
