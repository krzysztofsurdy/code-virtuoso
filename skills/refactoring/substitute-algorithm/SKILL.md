...
description: "Substitute Algorithm refactoring technique - replace an algorithm implementation with a clearer or more efficient one to improve code maintainability and performance"
---
