...
description: Simulate web browser behavior programmatically. Create clients that make requests, click links, and submit forms. Useful for testing, web scraping, and automated browser interactions without a GUI browser.
---
