---
name: symfony-ldap
description: Connect to and interact with LDAP servers (OpenLDAP or Active Directory). Use this skill for LDAP authentication, user querying, entry management, and server integration.
---
