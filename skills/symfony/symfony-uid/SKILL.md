---
name: symfony-uid
description: Generate, validate, convert, and compare universally unique identifiers (UUIDs v1-v8 and ULIDs). Use this skill for creating unique IDs, Doctrine entity primary keys, database-friendly sortable identifiers, and testing with mock factories.
---
