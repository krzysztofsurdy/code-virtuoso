...
description: Extract metadata about class properties including types, descriptions, accessibility, and initialization. Use PropertyInfo when you need to discover property information from class definitions without reading/writing values. The component integrates with multiple metadata sources (PHP reflection, PHPDoc, PHPStan, Doctrine, Serializer) and is essential for building metadata-driven frameworks and type-aware tools.
---
