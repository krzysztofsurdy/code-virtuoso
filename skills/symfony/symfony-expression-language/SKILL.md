...
description: Compile and evaluate dynamic expressions safely in a restricted PHP sandbox without security vulnerabilities. Use for business rules, validation, security checks, and dynamic configuration logic.
---
