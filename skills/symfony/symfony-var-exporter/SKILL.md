...
description: Export PHP data structures to plain PHP code and instantiate/hydrate objects without calling constructors. Use this skill to serialize objects for caching with OPcache optimization, create lazy proxy objects, and manipulate object properties directly without constructor side effects.
---
