...
description: Query, traverse, and extract data from HTML and XML documents programmatically. Use DomCrawler for web scraping, DOM navigation, form automation, testing, and parsing structured data from web pages without DOM manipulation capabilities.
---
