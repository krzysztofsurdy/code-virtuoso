...
description: Query and extract data from JSON structures using RFC 9535 JSONPath standard. Provides a DomCrawler-like interface for JSON with fluent query building and PHPUnit testing assertions.
---
