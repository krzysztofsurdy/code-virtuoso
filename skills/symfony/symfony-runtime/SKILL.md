...
description: Decouple bootstrapping logic from global state to enable applications to run with various runtimes like PHP-PM, ReactPHP, Swoole, and FrankenPHP without code changes. Use this skill to implement decoupled application bootstrapping and create custom runtimes for different execution environments.
---
