...
description: Handle synchronous and asynchronous message dispatching and queuing. Implement message buses, handlers, transports (AMQP, Doctrine, Redis, Beanstalkd), middleware, envelopes, and stamps for building event-driven architectures.
---
