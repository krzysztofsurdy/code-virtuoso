---
name: symfony-config
description: Define, validate, load, and cache configuration values with support for multiple formats (YAML, XML, INI, attributes). Use for building configurable bundles, managing complex configuration hierarchies, and optimizing configuration loading with caching strategies.
---
