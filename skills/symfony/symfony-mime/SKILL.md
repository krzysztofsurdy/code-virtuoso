---
name: symfony-mime
description: Manipulate MIME messages for email creation and provide utilities for MIME type management. Use this skill to create email messages with text and HTML content, attachments, embedded images, and custom headers. Also leverage MIME type guessing utilities to work with file extensions and content type detection.
---
