...
description: Provide platform-independent utilities for filesystem operations and path manipulation. Use this skill to handle file/directory creation, deletion, copying, permissions, symbolic links, and cross-platform path operations safely and reliably.
---
