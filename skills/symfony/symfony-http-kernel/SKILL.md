...
description: Use for building HTTP request-response handling, managing kernel events, resolving controllers and arguments, exception handling, and integrating with event-driven architecture. Essential for creating custom HTTP kernels, event listeners, middleware, error handlers, and request/response lifecycle management.
---
