---
name: symfony-cache
description: Comprehensive caching system providing PSR-6 compliant cache adapters, cache pools, tag-based invalidation, and stampede prevention. Use this skill when helping developers implement caching strategies, configure cache adapters, handle cache invalidation, and manage cached data efficiently.
---
