---
name: symfony-yaml
description: Parse and dump YAML files with a robust, fast parser. Convert between YAML strings/files and PHP arrays with support for complex data types, references, aliases, and custom tags.
---
