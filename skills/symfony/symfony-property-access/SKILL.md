...
description: Read and write from/to objects or arrays using simple string notation. Supports multiple access patterns including public properties, getters, setters, adders, removers, magic methods, and nested mixed object/array structures with full null-safety.
---
